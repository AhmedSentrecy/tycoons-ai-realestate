...
const milestones = [
  ...
  { year: "٢٠٢٥", text: "تطوير تجربة بحث صوتي بالعربي المصري لتقليل وقت البحث والمقارنة" },
  { year: "٢٠٢٦", text: "إطلاق بحث حي مبني على مئات الوحدات المتاحة من عشرات المطورين" },
];
      ...
      <section className="mx-auto max-w-4xl px-5 pb-24 lg:px-8">
        ...
        >
          ...
          <p className="mx-auto mt-3 max-w-md font-light leading-relaxed text-white/65">
            جرّب المساعد أو كلمنا مباشرة — وهنشوف إزاي نقدر نساعدك توصل للعقار المناسب.
          </p>

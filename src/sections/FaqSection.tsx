...
export default function FaqSection() {
  return (
    <section id="faq" className="scroll-mt-20 bg-[#f7f2ea] py-16 lg:py-20">
      <div className="mx-auto max-w-4xl px-5 lg:px-8">
        ...
        >
          <div className="mb-4 flex items-center justify-center gap-2.5">
            ...
            <span className="text-sm font-medium text-[#a3854e]">{tr("عندك سؤال؟")}</span>
          </div>
          <h2 className="text-3xl font-extrabold text-[#1b2420] sm:text-4xl">
            {tr("الأسئلة الشائعة")}</h2>
          <p className="mx-auto mt-3 max-w-md text-sm font-light leading-relaxed text-[#6d7a72]">
            {tr("كل اللي محتاج تعرفه عن الشراء من المطور مباشرة والبحث بالذكاء الاصطناعي.")}</p>
        </motion.div>
        ...
        >
          ...
          >
            {tr("شوف كل الأسئلة الشائعة")}<ArrowLeft className="h-4 w-4 transition-transform group-hover:-translate-x-1" />
          </Link>
        </motion.div>
      </div>
    </section>

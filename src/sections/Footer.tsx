      ...
      <div className="border-t border-white/10">
        <div className="mx-auto grid max-w-6xl gap-8 px-5 py-10 sm:grid-cols-2 lg:grid-cols-4 lg:px-8">
          ...
          <div>
            ...
            <details id="voice-privacy" className="mt-5 text-sm leading-7 text-white/70" dir="rtl">
              <summary className="cursor-pointer font-bold text-[#d9b87c]">الخصوصية والمحادثات الصوتية</summary>
              <div className="mt-3 space-y-3">
                <p>المساعد الصوتي يعمل بالذكاء الاصطناعي. يُستخدم صوتك لمعالجة طلبك والرد عليك، وقد يخطئ في فهم الكلام؛ يُرجى تأكيد الأرقام والتفاصيل المهمة. عدم حفظ تسجيل لدينا لا يعني عدم معالجة الصوت لدى مزوّد الخدمة.</p>
                <p>حفظ التسجيلات الصوتية وملخصاتها داخل لوحة المبيعات غير مفعّل حاليًا. عند تفعيل الميزة سنحدّث هذه التفاصيل ونوضّح طريقة بدء التسجيل وخياراتك قبل استخدامه.</p>
                <p>الغرض المخطط للحفظ هو متابعة طلبك ومراجعة جودة الخدمة، مع ربط التسجيل وملخص الاحتياجات بملف العميل. الوصول سيكون للمسؤولين المخوّلين فقط، وليس عبر روابط عامة. مدة الاحتفاظ وسياسة الحذف ستُحددان قبل التفعيل؛ لا توجد مدة معتمدة حاليًا.</p>
                <p>مشاركة الاسم ورقم التواصل اختيارية، ولا تعني الموافقة على رسائل تسويقية. لا تشارك بيانات بطاقات الدفع أو كلمات المرور في المحادثة. يمكنك طلب توضيح بشأن بياناتك أو تصحيحها أو حذفها عبر <a className="underline" href="https://wa.me/201200704344">التواصل مع Tycoons</a>.</p>
              </div>
            </details>
          </div>
        </div>
